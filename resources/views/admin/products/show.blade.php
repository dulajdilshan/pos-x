...
@section('content')
    ...
    <label for="addItemLbl" style="font-weight:bold; font-size:25px; color:#16A085;"><i class="fas fa-product-hunt"></i>
        {{$product->item_code}}</label>
                            ...
                            <div class="col-md-6">
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="supplier_name" name="supplier_name"
                                           value="{{$product->supplier()->first()->name}}" disabled/>
                                </div>
