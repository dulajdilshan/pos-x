        ...
        <section class="inputs">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 control-label">
                            <lable for="itemName" style="font-weight:bold; font-size:17; color:#16A085;">Item Name</lable>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 control-label">
                            <lable for="itemMainCat" style="font-weight:bold; font-size:17; color:#16A085;">Select a Main Category</lable>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-10 offset-md-1">
                            <div class="row">
                                <div class="col-md-6 control-label">
                                    <lable for="" style="font-weight:bold; font-size:14px; color:#85929E ;">Select a Sub Category 1</lable>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6 control-label">
                                    <lable for=" " style="font-weight:bold; font-size:14px; color:#85929E ;">Select a Sub Category 2</lable>
                                </div>
                                <div class="col-md-6">
