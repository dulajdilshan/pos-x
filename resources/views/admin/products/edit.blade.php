...
@section('content')
<lable for="addItemLbl" style="font-weight:bold; font-size:25px; color:#16A085;"><i class="fas fa-edit" ></i> EDIT ITEM</lable> 
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6 control-label">
                            <lable for=" " style="font-weight:bold; font-size:18px; color:#34495E; font-family: Arial, Helvetica, sans-serif;">Item Code</lable>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 control-label">
                            <lable for=" " style="font-weight:bold; font-size:17; color:#16A085;">Item Name</lable>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 control-label">
                            <lable for=" " style="font-weight:bold; font-size:17; color:#16A085;">Select a Main Category</lable>
                        </div>
                        <div class="col-md-6">
